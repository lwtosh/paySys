...
<template>
<div v-if="this.accessPlatformId !== '' && this.accessPlatformId !== null">
    <el-form
      :model="dataForm"
      :rules="dataRule"
      ref="dataForm"
      ...
      <el-form-item
        ...
        prop="dayMoney" 
        label-width="180px">
      {{this.dataForm.strDayMoney}}
      </el-form-item>
      <el-form-item
        label="商户类型"
        prop="type"
        label-width="260px" >
       <div v-if='this.dataForm.type === "1"'>普通商户</div>  
       <div v-if='this.dataForm.type === "2"'>平安银行商户</div>  
      </el-form-item>
      </div>
      <div class="box">
        <el-form-item
        ...
        prop="strBalance" 
       >
      {{this.dataForm.strBalance}}
      </el-form-item>
      <el-form-item
        label="在途金额"
        prop="strIntransitBalance" 
        label-width="295px">
      {{this.dataForm.strIntransitBalance}}
      </el-form-item>
      </div>
    ...
    <el-input style="max-height:220px;" type="textarea" v-model="dataForm.publicKey"></el-input>
    </el-form-item>
        ...
        if (valid) {
          this.$http({
            ...
            data: this.$http.adornData({
              accessPlatformId: this.accessPlatformId,
