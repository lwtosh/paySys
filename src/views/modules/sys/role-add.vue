     ...
     init (id) {
       ...
       if (id) {
         this.$http({
           ...
           var idx = this.defaultCheckedArr.indexOf(this.tempKey)
           if (idx === -1) {
             this.defaultCheckedArr.splice(idx, this.defaultCheckedArr.length - idx)
           }
           this.$refs.menuListTree.setCheckedKeys(this.defaultCheckedArr)
         })
       }
     },
     yc (arr) {
         ...
         if (valid) {
           this.$http({
             ...
             data: JSON.stringify({
               ...
               'bids': [].concat(this.$refs.menuListTree.getCheckedKeys(), [this.tempKey], this.$refs.menuListTree.getHalfCheckedKeys())
