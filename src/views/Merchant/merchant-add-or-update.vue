<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="支付渠道" prop="payCompanyKey">
         <el-select v-model="dataForm.payCompanyKey" placeholder="支付渠道">
  ...
  >
    <el-input  style="width: 26%;" v-model="merchantConfigs.key" placeholder="key" :maxlength="30"></el-input>
    <el-input  style="width: 26%;" v-model="merchantConfigs.value" placeholder="value" :maxlength="5000"></el-input>
    <el-input  style="width: 27%;" v-model="merchantConfigs.remark" placeholder="remark" :maxlength="150"></el-input>
      ...
      return {
        ...
        dataRule: {
          name: [
            ...
            {min: 2, max: 40, message: '长度在2到40位之间'}
          ],
          payCompanyKey: [
          ...
          description: [
             {min: 1, max: 225, message: '长度在1到225位之间'}
          ]
        }
      }
    },
